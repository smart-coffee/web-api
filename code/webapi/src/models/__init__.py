...
class Profile(DB.Model):
	...
	# Backref
	user_id_fk = DB.Column(DB.Integer, DB.ForeignKey('user.id', name='fk_profile_user'))
...
class CoffeeBrand(DB.Model):
	...
	# Relationships: 1..n
	products = DB.relationship('CoffeeProduct', backref='coffee_brand' )
...
class CoffeeType(DB.Model):
	...
	# Relationships: 1..n
	products = DB.relationship('CoffeeProduct', backref='coffee_type' )
...
class CoffeeProduct(DB.Model):
	...
	# Relationships: 1..n
	jobs = DB.relationship('Job', backref='coffee_product' )
...
class CoffeeMachine(DB.Model):
	...
	# Relationships: 1..n
	jobs = DB.relationship('Job', backref='coffee_machine' )
